	...
	<div class="cotainer">
        <div class="row justify-content-center">
            <div class="col-md-10 p-5">
                    <div class="card">
                        <div class="card-header text-center bg-info "><h3 class="text-white">Add Subject</h3></div>
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="" method="POST">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6 ">
                                        <input type="text" id="full_name" class="form-control box-bg " name="code">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" id="email_address" class="form-control box-bg" name="sem">
                                    </div>
                                </div>
								...
								<div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="date"  class="form-control box-bg" name="year" >
                                    </div>
                                </div>
							...
							<div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text"  class="form-control box-bg" name="credit" >
                                    </div>
                                </div>
							 ...
							 <div class="form-group row">
								...
								<div class="row"> 
                                    <div class="col-md-6 text-right">
                                        ...
                                        <a href="" class="text-light text-decoration-none">Add Subject</a>
                                        </button>
                                    </div>
...
if(isset($_POST['submit']))
{
	...
	$obj->AddSub($_POST['code'],$_POST['sem'],$_POST['year'],$_POST['credit'],$_POST['subname'],$_POST['admin_id']);
}
