...
<div class="cotainer">
        <div class="row justify-content-center">
            <div class="col-md-10 p-5">
                    <div class="card">
                        <div class="card-header text-center bg-info "><h3 class="text-white">Timetable</h3></div>
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="" method="POST">
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label text-md-right font-weight-bolder">Day</label>
                                    <div class="col-md-6 ">
                                        <input type="text" id="full_name" class="form-control box-bg " name="day">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" id="email_address" class="form-control box-bg" name="sub_name">
                                    </div>
                                </div>
								...
								<div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text"  class="form-control box-bg" name="d_name" >
                                    </div>
                                </div>
							
							<div class="form-group row">
                                    <label class="col-md-4 col-form-label text-md-right font-weight-bolder">Code</label>
                                    <div class="col-md-6">
                                        <input type="text"  class="form-control box-bg" name="code" >
                                    </div>
                                </div>
							
						
							 <div class="form-group row">
                                    <label class="col-md-4 col-form-label text-md-right font-weight-bolder">Time</label>
                                    <div class="col-md-6">
                                        <input type="text"  class="form-control box-bg" name="time">
                                    </div>
                                </div>
							 ...
							 <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text"  class="form-control box-bg" name="admin_id">
                                    </div>
                                </div>

							 <div class="form-group row">
                                    <label class="col-md-4 col-form-label text-md-right font-weight-bolder">Semester No</label>
                                    <div class="col-md-6">
                                        <input type="text"  class="form-control box-bg" name="semno">
                                    </div>
                                </div>
								...
								<div class="row"> 
                                    <div class="col-md-6 text-right">
                                        ...
                                        <a href="" class="text-light text-decoration-none">ADD Timetable</a>
                                        </button>
                                    </div>
...
if(isset($_POST['submit']))
{
	...
	$obj->Addtime($_POST['day'],$_POST['sub_name'],$_POST['c_name'],$_POST['code'],$_POST['time'],$_POST['admin_id'],$_POST['semno']);
}
