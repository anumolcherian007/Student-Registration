	...
	<div class="cotainer">
        <div class="row justify-content-center">
            <div class="col-md-10 p-5">
                    <div class="card">
                        <div class="card-header text-center bg-info "><h3 class="text-white">Add Course</h3></div>
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6 ">
                                        <input type="text" id="full_name" class="form-control box-bg " name="cname">
                                    </div>
                                </div>
								 ...
								 <div class="form-group row">
                                    ...
                                    <div class="col-md-6 ">
                                        <input type="text" id="full_name" class="form-control box-bg " name="dname">
                                    </div>
                                </div>
								...
								<div class="row"> 
                                    <div class="col-md-6 text-right">
                                        ...
                                        <a href="" class="text-light text-decoration-none">Add Course</a>
                                        </button>
                                    </div>
								</div>
...
if(isset($_POST['submit']))
{
	...
	$obj->Addcourse($_POST['cname'],$_POST['dname']);
}
