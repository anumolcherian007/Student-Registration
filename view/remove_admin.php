	...
	<div class="container">
		<div class="row">
			<div class="col-md-6 text-center bor py-4 t-center">
				<h2 class="fontcol">View Admin</h2>
			</div>
				...
				<div style="overflow-x:auto;">
					<table class="table table-hover">
						...
						<?php
							...
							$obj2=new Mycontroller();
							$result=$obj2->superviewadm();
						...
						?>
											...
											<form name="my-form" onsubmit="return validform()" action="" method="POST"> 
												...
												<tr>
												  <td> <input type="text" id="full_name" class="form-control box-bg " name="adminid" value="<?php echo $row['admin_id']?>" readonly></td>
												  <td><input type="text" id="full_name" class="form-control box-bg " name="usnm" value="<?php echo $row['username']?>" readonly></td>
												  <td><input type="text" id="full_name" class="form-control box-bg " name="email" value="<?php echo $row['email']?>" readonly></td>
												  <td><input type="text" id="full_name" class="form-control box-bg " name="pswd" value="<?php echo $row['password']?>" readonly></td>
												  <td><button type="submit" class="btn btn-primary " onclick="say()" name="submit">
														<a href="" class="text-light text-decoration-none">Remove Admin</a>
													  </button>
													</td>
															...
															<?php
																if(isset($_POST['submit']))
																{
																	...
																	$result=$obj->Removeadmn($_POST['email']);
																}
